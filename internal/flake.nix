{
  ...
  inputs = {
    ...
    tree-sitter-abl = {
      url = "github:usagi-coffee/tree-sitter-abl";
      flake = false;
    };
    tree-sitter-abnf = {
      url = "github:jmitchell/tree-sitter-abnf";
      flake = false;
    };
    ...
    tree-sitter-asa = {
      url = "github:menaruben/tree-sitter-asa";
      flake = false;
    };
    ...
    tree-sitter-astra = {
      url = "github:denartha10/tree-sitter-astra";
      flake = false;
    };
    tree-sitter-astro = {
    ...
    tree-sitter-bend = {
      url = "github:atomheartother/tree-sitter-bend";
      flake = false;
    };
    tree-sitter-bibtex = {
    ...
    tree-sitter-blame = {
      url = "github:github/codeql";
      flake = false;
    };
    tree-sitter-blom = {
      url = "github:xhyrom-utils/tree-sitter-blom";
      flake = false;
    };
    ...
    tree-sitter-branescript = {
      url = "github:DanielVoogsgerd/treesitter-branescript";
      flake = false;
    };
    tree-sitter-breaker = {
    ...
    tree-sitter-bru = {
      url = "github:pedrobarco/tree-sitter-bru";
      flake = false;
    };
    tree-sitter-bruno = {
      url = "github:Scalamando/tree-sitter-bruno";
      flake = false;
    };
    tree-sitter-bteq = {
      url = "github:aamayam/tree-sitter-bteq";
      flake = false;
    };
    tree-sitter-c = {
    ...
    tree-sitter-capy = {
      url = "github:capy-language/tree-sitter-capy";
      flake = false;
    };
    tree-sitter-carbon = {
      url = "github:carbon-language/carbon-lang/0d70091bdab7dd945966da0691de107dbff7c7da";
      flake = false;
    };
    ...
    tree-sitter-cerium = {
      url = "github:cerium-lang/tree-sitter-cerium";
      flake = false;
    };
    tree-sitter-cfml = {
    ...
    tree-sitter-conl = {
      url = "github:ConradIrwin/tree-sitter-conl";
      flake = false;
    };
    tree-sitter-conllu = {
      url = "github:pmagistry/tree-sitter-conllu";
      flake = false;
    };
    tree-sitter-context = {
    ...
    tree-sitter-convex = {
      url = "github:crimeminister/tree-sitter-convex-lisp";
      flake = false;
    };
    ...
    tree-sitter-corth = {
      url = "github:corth-lang/tree-sitter-corth";
      flake = false;
    };
    tree-sitter-cpcss = {
      url = "github:codepen/tree-sitter-cpcss";
      flake = false;
    };
    tree-sitter-cpon = {
    ...
    tree-sitter-cypher = {
      url = "github:pupli/tree-sitter-cypher";
      flake = false;
    };
    tree-sitter-cython = {
    ...
    tree-sitter-desktop = {
      url = "github:ValdezFOmar/tree-sitter-desktop";
      flake = false;
    };
    ...
    tree-sitter-editorconfig = {
      url = "github:ValdezFOmar/tree-sitter-editorconfig";
      flake = false;
    };
    tree-sitter-edl = {
      url = "github:LateinCecer/tree-sitter-edl";
      flake = false;
    };
    tree-sitter-edoc = {
    ...
    tree-sitter-egglog = {
      url = "github:hatoo/tree-sitter-egglog";
      flake = false;
    };
    tree-sitter-eiffel = {
    ...
    tree-sitter-exoterra = {
      url = "github:tpkessler/tree-sitter-exoterra";
      flake = false;
    };
    ...
    tree-sitter-gobra = {
      url = "github:HSMF/tree-sitter-gobra";
      flake = false;
    };
    ...
    tree-sitter-gularen = {
      url = "github:noorwachid/tree-sitter-gularen";
      flake = false;
    };
    tree-sitter-hack = {
    ...
    tree-sitter-humphrey = {
      url = "github:SavourySnaX/tree-sitter-humphrey";
      flake = false;
    };
    tree-sitter-hurl = {
    ...
    tree-sitter-idris = {
      url = "github:kayhide/tree-sitter-idris";
      flake = false;
    };
    tree-sitter-iex = {
    ...
    tree-sitter-isle = {
      url = "github:eagr/tree-sitter-isle";
      flake = false;
    };
    tree-sitter-ispc = {
    ...
    tree-sitter-jelly = {
      url = "github:OpenJelly/tree-sitter-jelly";
      flake = false;
    };
    tree-sitter-jinja2 = {
    ...
    tree-sitter-ldif = {
      url = "github:kkmp-dk/tree-sitter-ldif";
      flake = false;
    };
    tree-sitter-lean = {
    ...
    tree-sitter-man-db-config = {
      url = "github:TornaxO7/tree-sitter-man-db-config";
      flake = false;
    };
    tree-sitter-markdoc = {
      url = "github:mohitsinghs/tree-sitter-markdoc";
      flake = false;
    };
    ...
    tree-sitter-marte = {
      url = "github:MARTe-Community/tree-sitter-marte";
      flake = false;
    };
    tree-sitter-martian = {
    ...
    tree-sitter-mips = {
      url = "github:cknacayama/tree-sitter-mips";
      flake = false;
    };
    tree-sitter-mlir = {
    ...
    tree-sitter-mustache = {
      url = "github:TheLeoP/tree-sitter-mustache";
      flake = false;
    };
    tree-sitter-muttrc = {
    ...
    tree-sitter-myst = {
      url = "github:elxy/tree-sitter-myst";
      flake = false;
    };
    tree-sitter-nasl = {
    ...
    tree-sitter-nois = {
      url = "github:nois-lang/tree-sitter-nois";
      flake = false;
    };
    tree-sitter-norg = {
    ...
    tree-sitter-owl-ms = {
      url = "github:janekx21/tree-sitter-owl-ms";
      flake = false;
    };
    tree-sitter-pactum = {
      url = "github:pactbuf/tree-sitter-pactum";
      flake = false;
    };
    tree-sitter-pascal = {
    ...
    tree-sitter-possum = {
      url = "github:mulias/tree-sitter-possum";
      flake = false;
    };
    tree-sitter-poweron = {
    ...
    tree-sitter-pyjsx = {
      url = "github:mplemay/tree-sitter-pyjsx";
      flake = false;
    };
    ...
    tree-sitter-pyrope = {
      url = "github:masc-ucsc/tree-sitter-pyrope";
      flake = false;
    };
    tree-sitter-python = {
    ...
    tree-sitter-quakec = {
      url = "github:vkazanov/tree-sitter-quakec";
      flake = false;
    };
    tree-sitter-query = {
    ...
    tree-sitter-regent = {
      url = "github:ellishg/tree-sitter-regent";
      flake = false;
    };
    tree-sitter-regex = {
    ...
    tree-sitter-rifleconfig = {
      url = "github:purarue/tree-sitter-rifleconfig";
      flake = false;
    };
    tree-sitter-risor = {
      url = "github:applejag/tree-sitter-risor";
      flake = false;
    };
    tree-sitter-rnc = {
      url = "github:LdBeth/tree-sitter-rnc";
      flake = false;
    };
    tree-sitter-rnoweb = {
    ...
    tree-sitter-runescript = {
      url = "github:LostCityRS/tree-sitter-runescript";
      flake = false;
    };
    tree-sitter-rust = {
    ...
    tree-sitter-sed = {
      url = "github:mskelton/tree-sitter-sed";
      flake = false;
    };
    tree-sitter-selinux = {
      url = "github:mdmfernandes/tree-sitter-selinux";
      flake = false;
    };
    tree-sitter-semver = {
    ...
    tree-sitter-shosts = {
      url = "github:Smart-Hosts/tree-sitter-shosts";
      flake = false;
    };
    tree-sitter-skbdrc = {
    ...
    tree-sitter-sus = {
      url = "github:pc2/tree-sitter-sus";
      flake = false;
    };
    tree-sitter-svelte = {
    ...
    tree-sitter-syphon = {
      url = "github:syphon-lang/tree-sitter-syphon";
      flake = false;
    };
    ...
    tree-sitter-teika = {
      url = "github:neubaner/tree-sitter-teika";
      flake = false;
    };
    tree-sitter-templ = {
    ...
    tree-sitter-test = {
      url = "github:tree-sitter-grammars/tree-sitter-test";
      flake = false;
    };
    ...
    tree-sitter-times = {
      url = "github:michaeladler/tree-sitter-times";
      flake = false;
    };
    tree-sitter-tl = {
      url = "github:PoopyPooOS/tree-sitter-tl";
      flake = false;
    };
    tree-sitter-tlaplus = {
    ...
    tree-sitter-todome = {
      url = "github:monaqa/tree-sitter-todome";
      flake = false;
    };
    tree-sitter-todotxt = {
    ...
    tree-sitter-wbproto = {
      url = "github:acristoffers/tree-sitter-wbproto";
      flake = false;
    };
    tree-sitter-wdl = {
    ...
    tree-sitter-zote = {
      url = "github:KvGeijer/tree-sitter-zote";
      flake = false;
    };
    tree-sitter-zscript = {
